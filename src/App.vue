<template>
  <div id="app">
    ...
    <p>Consultando datos de <a href="https://invi.sible.link">https://invi.sible.link</a> </p>
...
export default {
  ...
  data () {
    return {
      countries: [{short:'py', name:'paraguay',campaign:'gob.paraguay'},
    ...
    getSurfaceData(campaign){
      ...
      this.$http.get(`https://invi.sible.link/api/v1/surface/${campaign}`)            
          ...
          .then(data => {
            ...
            this.serverData = this.serverData.concat(this.processLeaders(data, country));
